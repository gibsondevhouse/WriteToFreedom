...
const directory=initDirectoryShell({
 ...
 renderItem(arc){
  const dates=[arc.startDate,arc.endDate].filter(Boolean).join(' → '),record={...arc,name:arc.name||'Untitled story arc',href:'/story-arcs/'+encodeURIComponent(arc.id)+'/'};
