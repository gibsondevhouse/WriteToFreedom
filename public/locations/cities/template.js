...
export const citySections=[
 {id:'identity',title:'City information',fields:[['name','Name','input'],['officialName','Official name','input'],['parentId','Country','country'],['region','State / province / region','input'],['nickname','Nicknames','input'],['motto','Motto','input'],['settled','Settled','date'],['incorporated','Incorporated / chartered','date'],['founder','Founder','input'],['governmentType','Government','choice'],['governingBody','Governing body','input'],['leaderId','Mayor / city leader','character'],['area','Area','input'],['elevation','Elevation','input'],['population','Population','input'],['populationDate','Population as of','date'],['demonym','Demonym','input'],['officialLanguages','Languages','choice'],['timeZone','Time zone / calendar','input']]},
