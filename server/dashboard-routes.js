 ...
 * countries (saved profiles), cities (saved profiles).
 * @returns {object} {questions, characters, factions, locations, timeline}.
 */
export function dashboardData({characters,factions,locations,countries,cities}){
 ...
 const profiles={...locationProfileGroups(locations),character:cast,faction:factions,country:countryProfiles,city:cityProfiles};
