...
const names={lore:'Lore',character:'Character',faction:'Faction',...typeLabels};
 ...
 */
export function dashboardData({characters,factions,locations,countries,cities,lore=[]}){
 ...
 const profiles={...locationProfileGroups(locations),lore,character:cast,faction:factions,country:countryProfiles,city:cityProfiles};
...
export async function dashboardRoute(request,env){
 ...
 try{
  ...
  return json(dashboardData({characters,factions,locations,countries,cities,lore}));
