const sections = [
  ...
  ['Worldbuilding', [['Characters', '/characters/', 'characters'], ['Factions', '/factions/', 'factions'], ['Locations', '/locations/', 'locations']]],
...
export function workspaceShell(html, path) {
  ...
  const shell = `<aside id="workspace-sidebar" class="workspace-sidebar" aria-label="Workspace sidebar">
    ...
    <header class="workspace-topbar">
      ...
      <search class="workspace-search" aria-label="Search your novel"><label class="shell-sr-only" for="novel-search">Search characters, factions, and locations</label><span class="search-symbol" aria-hidden="true">${shellIcon('search')}</span><input id="novel-search" type="search" placeholder="Search your novel…" aria-controls="search-results" autocomplete="off"><kbd aria-hidden="true">⌘ K</kbd></search>
