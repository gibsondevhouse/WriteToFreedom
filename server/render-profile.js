...
export function renderProfile(character, cast, factions=[],locations=[]) {
 ...
 return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark"><title>${name} — Write to Freedom</title><link rel="icon" href="/crest.svg"><link rel="stylesheet" href="/characters/profile.css"><link rel="stylesheet" href="/characters/profile-editor.css?v=profile-name-card"><script type="module" src="/characters/profile-editor.js?v=profile-controls-2"></script></head><body class="character-profile"><div class="page-layout"><main id="profile"><nav class="breadcrumb" aria-label="Breadcrumb"><a href="/">Home</a> / <a href="/characters/">Characters</a> / <span aria-current="page" data-display-name>${name}</span></nav><form id="profile-form"><div class="article-bar"><span class="current-view">Character profile</span><div class="save-actions"><span id="save-status" role="status">Saved</span><button id="save-character" type="submit">Save changes</button></div></div><p class="byline">Click any field to edit your character.</p><p id="editor-error" role="alert" hidden></p><noscript>Enable JavaScript to edit and save this profile.</noscript><fieldset id="editor-fields"><legend class="sr-only">Character profile</legend><article><aside class="infobox" id="identity" aria-label="Character information"><h1 class="profile-name"><button type="button" id="edit-name" title="Edit character name" data-display-name>${name}</button></h1><div class="epithet-field">${field(templateSections[0].fields.find(f=>f[0]==='title'))}</div><div class="identity-panel ${color}"><span class="monogram" id="monogram">${initials}</span></div>${cardGroups}<small class="name-hint">Dates can use your story’s calendar. Height and weight use the selected units.</small><small class="name-hint">Names can include hyphens and spaces.</small></aside>${body}</article></fieldset></form><footer class="profile-footer"><a href="/characters/">← Back to characters</a><a href="#profile">Back to top ↑</a></footer></main></div><script id="profile-data" type="application/json">${data}</script></body></html>`;
}
