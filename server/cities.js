...
export function defaultCity(location){return {...blankCity(),...(location.id==='sample-capital'?{
 ...
 }:{}),id:location.id,name:location.name,parentId:location.parentId,version:0};}
