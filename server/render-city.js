...
export function renderCity(city,locations,cast){
 ...
 const infobox=renderProfileName(city,'city',{official:true})+`<p class="country-assignment">City in <a data-country-link href="/locations/countries/${escape(city.parentId)}/">${escape(parent?.name||'Country')}</a></p>`+
